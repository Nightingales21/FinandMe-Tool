...
const PHASES = ['Upload', 'Goals', 'Categorise', 'Confirm', 'Review', 'Plan'];
  ...
  return (
    <div className="app">
      ...
      <main className="app-main">
        {phase === 0 && <UploadPhase onUpload={handleUpload} />}
        {phase === 1 && portfolio && <GoalPhase portfolio={portfolio} onDone={handleGoalsSet} />}
        {phase === 2 && (
